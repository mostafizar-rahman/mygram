...
function Login() {
    const { userLogin, userLoginWithGoogle, loading } = useContext(ContextProvider)
    ...
    return (
        <section className='max-w-[1400px] mx-auto py-10 px-3'>
            <div className="w-full max-w-sm mx-auto min-h-[calc(100vh-80px)] h-full">
                ...
                <form onSubmit={handleLoginFormSubmit} className="space-y-6">
                    ...
                    <button type='submit' className='btn bg-red-700 w-full text-white relative rounded-md min-h-[40px]'>{loading ?
